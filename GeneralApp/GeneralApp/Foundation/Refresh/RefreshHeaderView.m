...
#import "UIView+WFRefreshExtension.h"
#import "UIScrollView+WFRefreshExtension.h"
...
- (void)updateTimeLabel
{
    ...
    NSDateComponents *cmp1 = [calendar components:unitFlags fromDate:self.lastUpdateTime];
